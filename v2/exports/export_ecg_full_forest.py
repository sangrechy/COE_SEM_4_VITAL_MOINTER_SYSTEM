...
MODEL_PATH = "v2/ml/v1/ecg/models/ecg_rf_multiclass.pkl"
OUTPUT_PATH = "v2/ml/v1/ecg/results/ecg_forest_export.c"

model = joblib.load(MODEL_PATH)

with open(OUTPUT_PATH, "w") as f:

    f.write("// AUTO GENERATED ECG RANDOM FOREST\n\n")
    f.write(f"#define ECG_TREE_COUNT {len(model.estimators_)}\n\n")
...
print("=================================")
print("ECG Forest Export Complete")
print("=================================")
